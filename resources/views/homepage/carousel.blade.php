<div id="homePageCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="{{ asset('images/1.jpg') }}" alt="" width="100%" height="100%" aria-hidden="true"
        ...
        <div class="carousel-item">
            <img src="{{ asset('images/2.jpg') }}" alt="" width="100%" height="100%" aria-hidden="true"
                preserveAspectRatio="xMidYMid slice" focusable="false" style=" object-fit: cover;">
        ...
        <div class="carousel-item">
            <img src="{{ asset('images/7.jpg') }}" alt="" width="100%" height="100%" aria-hidden="true"
                preserveAspectRatio="xMidYMid slice" focusable="false" style=" object-fit: cover;">
            {{-- <div class="container">
