<section class="cmd-message-container h-100 px-5 pt-5">
    <div class="d-flex justify-content-between align-items-center">

        <h3 class="">Message from the CMD</h3>
        <img src="{{ asset('images/cmd-sk1.png') }}" alt="" width="115" height="115" class="rounded-circle"
            style="object-fit:cover">
    </div>
    <div>
        <div class="cmd-name-title">Shri. A.N. Srivastava</div>
        <div class="cmd-designation">Chairman & Managing Director</div>
    </div>
