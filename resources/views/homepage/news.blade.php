<div class="section-heading d-flex justify-content-between align-items-center mb-3">
    ...
    <div>
        <x-hyperlinkbutton href="{{ route('publicnews') }}" class="" :outline="true">
            All News <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" width="20">
                        ...
                        <div class="news-title d-flex align-items-center ">
                            ...
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="#94701D" height="30">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="flex-grow-1">
                                <div class="news-title ">
                                    ...
                                    @if($key<2) <div class="badge badge-new ms-2 text-uppercase fw-light">New</div>   @endif 
                                </div>
