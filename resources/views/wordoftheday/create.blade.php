            ...
            <x-card>
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('wordoftheday.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-3">
                            <x-input-label for="word_meaning" :value="__('Today\'s Word in Tamil')" class="col-4 col-form-label" />
                            <div class="col-8">
                                <textarea id="word_meaning" class="form-control" :value="old('word_meaning')"  autocomplete="word_meaning" required /></textarea>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-8">
                                <x-text-input id="word_audio_file" class="" :value="old('word_audio_file')" type="file"
                                    name="word_audio_file" required accept="audio/mp3"/>
