...
<x-guest-layout>
    ...
    <div class="container-fluid mt-3">
        ...
        <div class="row mx-2">
            <div class="col-6">
                <h4>Latest News & Announcements</h3>
                    <div class="row">
                        <div class="col-6">

                            <div class="newsCard">
                                <div class="d-flex justify-content-between">
                                    <div class="newsCat">Corporate</div>
                                    <div class="newsDate">23/02/2023</div>
                                </div>


                                <div class="newsImage mb-3">
                                    <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
                                        width="500" height="150" xmlns="http://www.w3.org/2000/svg" role="img"
                                        ...
                                        <rect width="100%" height="100%" fill="var(--bs-secondary-bg)"></rect><text
                                            x="50%" y="50%" fill="var(--bs-secondary-color)"
                                            dy=".3em">500x500</text>
                                    </svg>
                                </div>

                                <h3 class="newsTitle">
                                    MOU with ISB, Hyderabad
                                </h3>
                                <p class="featuredNewsExcerpt">
                                    Signed MOU with Administrative Staff College of India(ASCI), Hyderabad - for Mutual
                                    Collaboration, Consultancy, Research and Exchange of Faculty etc., in the domain of
                        ...
                        <div class="col-6">
                            <div class="row">
                                <div class="col-6 mb-4">
                                    <div class="d-flex justify-content-between">
                                        <h6>Small News Title</h6>
                                        <div class="newsPublishedDate text-muted">26/03</div>
                                    </div>

                                    <p class="newsExcerpt">
                                        Signed MOU with Administrative Staff College of India(ASCI), Hyderabad - for
                                        Mutual
                                        Collaboration, Consultancy, Research and Exchange of Faculty etc., in the domain
                                        of
                                        Training
                                        & Development.
                                    </p>
