...
class Settings extends Model
{
    ...
    {
        return self::getDefinedSettingsFields()->pluck('rules', 'name')
            ->reject(function ($val) {
                return is_null($val);
            })->toArray();
    }
    ...
    {
        $type  = self::getDefinedSettingsFields()
            ->pluck('data', 'name')
            ->get($field);
    ...
    {
        return self::getDefinedSettingsFields()
            ->pluck('value', 'name')
            ->get($field);
    }
    ...
    private static function getDefinedSettingsFields()
    {
        return collect(config('settings_fields'))->pluck('elements')->flatten(1);
    }
